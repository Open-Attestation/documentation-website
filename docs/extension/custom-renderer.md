...
![Default Story Book View](/docs/extension/custom-renderer/default-storybook.png)
...
![Completed Story Book View](/docs/extension/custom-renderer/completed-storybook.png)
...
![Create a new site on netlify](/docs/extension/custom-renderer/netlify-new.png)

Select "New Site From Git" and then "GitHub".

![Build settings](/docs/extension/custom-renderer/netlify-build.png)

On the build page, enter `npm run build` as the "Build command" and `dist` as the "Publish Directory" and click on "Deploy Site".

![Sample Deployed URL](/docs/extension/custom-renderer/netlify-deployed.png)
