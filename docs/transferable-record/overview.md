...
This tutorial builds onto the knowledge from the [verifiable document](../../verifiable-document/overview) section. If you have not completed the tutorial for verifiable document, please head back to the previous section.
