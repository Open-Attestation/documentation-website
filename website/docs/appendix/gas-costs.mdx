...
:::note
Note that the following estimations are _not_ a comprehensive list of all the costs involved and should be used as a reference only.
...
:::note
The estimated gas may change along with the updates we have to the contracts. The current estimation is based on Token Registry v3.0.0.
:::
