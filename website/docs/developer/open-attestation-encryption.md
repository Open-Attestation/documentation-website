...
The [Open Attestation (Encryption)](https://github.com/Open-Attestation/oa-encryption) repository is the codebase for the npm module that allows you ti encrypt documents in order to share and store them safely.
...
- Programmatic verification of OA documents (refer to [Open Attestation (Verify)](/docs/developer/open-attestation))
