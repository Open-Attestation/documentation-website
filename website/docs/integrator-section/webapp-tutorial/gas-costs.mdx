...
:::note
The estimated gas may change along with the updates in the contracts. The current estimation is based on Document Store v2.2.3 and Token Registry v3.0.0.
:::
